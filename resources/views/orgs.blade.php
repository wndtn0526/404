{{-- 조직 관리 — Figma GPRO_PORTFOLIO (sJC6AduTG0I4cTttQJFAes · node 1002-274184 "page")
     ...
     ⚠️ 원본 상단 알약 탭이 7개인데, 그건 이 화면의 하위 탭이 아니라 그때까지 들른 메뉴
        바로가기다(x-menu-tabs). 그래서 여기서 목록을 정하지 않는다.
     ...
     트리 연결선은 원본이 얇은 사각형 여러 개로 그려져 있다. 단계별 세로선 + 잎 엘보로
     같은 그림을 만든다 — 자세한 건 아래 트리 주석에 있다.
...
<x-layout title="조직 관리">
    ...
    >
        ...
        <x-slot:title>
            ...
            <x-menu-tabs menu="orgs" label="조직 관리" href="/orgs" />
        </x-slot:title>
